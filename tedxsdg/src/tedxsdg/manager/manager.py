...
class CrewAIManager:
    ...
    def __init__(self, agents_config_path: str, tasks_config_path: str, tools_config_path: str = "config/tools.yaml"):
    ...
    def _log_llm_use(self) -> None:
        # Iterate through tool configurations to log LLM usage
        for tool_name, tool_config in self.tools_config.items():
            ...
            logger.info("Tool '%s' uses LLM - Provider: %s, Model: %s, Temperature: %s", tool_name, provider, model, temperature)
