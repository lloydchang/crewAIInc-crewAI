...
class CrewAIManager:
    ...
    def __init__(self, agents_config_path: str, tasks_config_path: str, model_config_path: str,
        ...
        self.tool_registry = ToolRegistry()  # noqa: E501

        # Set memory flag
        self.memory = True  # noqa: E501

        # Log LLM use
        self._log_llm_use(self.tool_config['llm'])

    def _validate_config_path(self, config_path: str, config_name: str) -> None:  # noqa: E501
    ...
    def _log_llm_use(self, llm_config: Dict[str, Any]) -> None:
        logger.debug("Logging LLM use: %s", llm_config)  # noqa: E501
        ...
        temperature = llm_config.get('temperature', 'N/A')  # noqa: E501
        logger.info("Using LLM - Provider: %s, Model: %s, Temperature: %s", provider, model, temperature)

    def _initialize_tool_config(self) -> Dict[str, Any]:  # noqa: E501
        try:  # noqa: E501
            ...
            tool_config_data = {  # noqa: E501
                "llm": llm_config,
                "embedder": embedder_config
            }

            logger.debug("Tool config data: %s", tool_config_data)
            return tool_config_data  # noqa: E501
    ...
    def create_task(self, task_name: str) -> None:
        ...
        logger.debug("Agent '%s' found or created", agent_name)  # noqa: E501
    ...
    def _create_agent(self, agent_name: str) -> Agent:
        ...
        try:
            if not self.tool_config['llm'] or not self.tool_config['embedder']:  # noqa: E501
    ...
    def initialize_crew(self) -> Crew:  # noqa: E501
        """
